...
<c:set var="titleName" value="비밀번호 찾기" scope="request"/>
...
<body>
	                  ...
	                  <div class="p-5">
	                    ...
	                    <form class="user" novalidate method="post">
												<div class="mb-4">
														...
														<input  class="form-control" name="memberId" type="text" id="memberId" required placeholder="아이디를 입력해주세요."/>
	                      ...
	                      <button class="btn-getstarted w-100">비밀번호 찾기</button>
	                    </form>
	...
	<div class="modal" tabindex="-1" id="pwFindModal">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">비밀번호 찾기 성공</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body success">
					<strong>성공! 임시 비밀번호를 이메일로 보내들렸습니다</strong>
				</div>
	...
	<div class="modal" tabindex="-1" id="pwFindErrorModal">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">비밀번호 찾기 실패</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body error">
					<strong>찾으시는 정보가 없습니다.</strong>
					<h2></h2>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">닫기</button>
		...
		<script>
			...
			document.querySelector("form").addEventListener("submit", async (e) => {
				...
				try {
					const response = await fetch("/hurdles/auth/pwFind.do",
					...
					let data = await response.json(); // JSON 형태로 응답 처리
						...
						if (data != null && data.item) {
							...
							if (item == "success") {
								modal = document.querySelector("#pwFindModal");
							} else {
								modal = document.querySelector("#pwFindErrorModal");
							}
