...
<c:set var="nav" value="noticeDetail" scope="request"/>
<c:set var="titleName" value="공지사항 상세보기" scope="request"/>
 ...
 <!-- Sidebar -->
	...
	<div class="container-fluid">
     	<div class="bg-white rounded p-3 m-2">
			<div class="mt-3">
		        ...
		        <div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">게시 내용</label>
		          <div class="col-sm-3 col-form-label">
 	 ...
 	 <div class="form-actions">
				<a href="noticeList.do" class="btn btn-outline-dark">목록</a>
				<a href="noticeUpdate.do?boardNo=${board.boardNo }" class="btn btn-outline-primary">수정</a>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog" role="document">
					<form action="<%=request.getContextPath() %>/admin/noticeDelete.do" method="post" id="delForm">
