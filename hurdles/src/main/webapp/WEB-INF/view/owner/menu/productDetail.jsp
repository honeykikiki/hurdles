...
<c:set var="titleName" value="${restaurantName} -  배송상품 상세보기" scope="request"/>
		 	...
		 	<div class="bg-white rounded p-3 m-2">
				<div class="mt-3">
					<div class="form-group mb-3 row">
						<label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">배송상품 이름</label>
							<div class="col-sm-3 col-form-label">
							<div class="contents">${item.productName}</div>
							</div>
					</div>

						<div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">배송상품 설명</label>
		          <div class="col-sm-3 col-form-label">
								<div class="contents">${item.productDes == null || item.productDes == '' ? '설명이 없습니다' : item.productDes}</div>
		          </div>
		        </div>

		        <div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">배송상품 가격</label>
		          <div class="col-sm-3 col-form-label">
		            <div class="contents"><fmt:formatNumber value="${item.productPrice}" pattern="#,###"/>원</div>
		          </div>
		        </div>

		        <div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">배송상품 생성일</label>
		          <div class="col-sm-3 col-form-label">
				...
				<div class="form-actions">
					<a href="productList.do?restaurantNo=${item.restaurantNo}&restaurantName=${restaurantName}" class="btn btn-outline-dark">목록</a>
