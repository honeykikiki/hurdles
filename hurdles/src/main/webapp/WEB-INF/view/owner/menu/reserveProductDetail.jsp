...
<c:set var="titleName" value="${restaurantName} -  예약메뉴 상세보기" scope="request"/>
...
<body>
		 	...
		 	<div class="bg-white rounded p-3 m-2">
				<div class="mt-3">
					<div class="form-group mb-3 row">
						<label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">예약메뉴 이름</label>
							<div class="col-sm-3 col-form-label">
							<div class="contents">${item.reserveProductName}</div>
							</div>
					</div>

						<div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">예약메뉴 설명</label>
		          <div class="col-sm-3 col-form-label">
		            <div class="contents">${item.reserveProductDes == null || item.reserveProductDes == '' ? '설명이 없습니다' : item.reserveProductDes}</div>
		          </div>
		        </div>

		        <div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">예약메뉴 최대 인원수</label>
		          <div class="col-sm-3 col-form-label">
		            <div class="contents"><fmt:formatNumber value="${item.reserveProductCount}" pattern="#,###"/>명</div>
		          </div>
		        </div>

		        <div class="form-group mb-3 row">
		          <label class="col-sm-3 col-md-2 col-lg-2 col-xl-1 col-form-label" for="fullName">예약메뉴 생성일</label>
		          <div class="col-sm-3 col-form-label">
				...
				<div class="form-actions">
					<a href="reserveProductList.do?restaurantNo=${item.restaurantNo}&restaurantName=${restaurantName}" class="btn btn-outline-dark">목록</a>
  ...
  <div class="modal fade" id="menuDeleteModal" tabindex="-1" role="dialog" aria-labelledby="menuDeleteModal" aria-hidden="true">
      <div class="modal-dialog" role="document">
					<form action="reserveProductDelete.do" method="post">
